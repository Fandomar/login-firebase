...
class MainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        val btLogin = binding.btSignin
        val btRegister = binding.btCreate
        ...
        btLogin.setOnClickListener {
            signInAccount(binding.etEmail.text.toString(), binding.etPass.text.toString())
        }
    }
    ...
    private fun updateUI(user: FirebaseUser?) {
        ...
        if (user == null) {
            binding.lyLogin.isVisible = true
            binding.lyRegister.isVisible = true
        } else {
            goToHome()
        }
    }
